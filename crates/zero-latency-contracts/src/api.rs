...
mod tests {
    ...
    fn test_dynamic_endpoints() {
        assert_eq!(super::endpoints::collection_by_name("test"), "/api/collections/test");
        assert_eq!(super::endpoints::collection_stats("test"), "/api/collections/test/stats");
        assert_eq!(super::endpoints::document_by_id("123"), "/api/documents/123");
    }
