...
use super::indexing_strategies::{IndexingStrategy, StandardIndexingStrategy};
...
impl IndexingService {
    ...
    pub async fn get_progress(&self) -> Result<super::interfaces::ProgressStats> {
    ...
    pub async fn get_collection_stats(&self, name: &str) -> Result<super::interfaces::CollectionStats> {
